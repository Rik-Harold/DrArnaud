  ...
  <div>
    <div class="conteneur">
      <div
        ...
        class="col-12 col-md-5 col-lg-6 pt-5 niveau"
      >
        <slot name="date" class="date">la date de debut de formation </slot>
        <br />
        <slot name="annee" class="mt-2 annee">l'annee de db de formation</slot
        ><br />
      </div>
      ...
      <div
        data-aos="fade-left"
        data-aos-duration="2000"
        class="col-12 col-md-6 col-lg-6 pt-5 serie"
      >
        <div class="niv">
